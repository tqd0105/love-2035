  ...
  return (
    <section className="relative flex min-h-[50vh] items-center justify-center overflow-hidden py-20">
      ...
      <div className="pointer-events-none absolute inset-0 -z-10">
        ...
        <div className="absolute bottom-1/3 right-1/4 h-[320px] w-[320px] rounded-full bg-purple-400/12 blur-3xl" />
      ...
      <div className="text-center">
        ...
        >
          <IconHeart size={30} className="text-white" />
        </motion.div>
        ...
        <motion.h1
          ...
          className="mb-3 font-serif text-4xl font-bold leading-tight sm:text-5xl lg:text-6xl"
        >
        ...
        >
          Our Journey Together — Hành trình yêu thương của đôi mình
        </motion.p>
      </div>
    </section>
  )
